...
function commonLoop() {
  return [
    ...
    '5. Keep private communication, task boards, roadmaps, assigned-agent state, reviewed drafts, implemented-system ledgers, Project Memory, duplicate-risk ledgers, and live production focus out of `.molthub/project.md`; those belong in MoltHub Workbench/API state.',
    ...
    '- Consult Project Memory through project inspect or plan before proposing new systems, reusable components, conventions, or replacements.',
    ...
    '- Do not create `.mothub/`, `.molthub/registry/*`, or parallel private metadata folders.',
